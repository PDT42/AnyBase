...
let MetaAnytyService = class MetaAnytyService {
    ...
    async create(metaAnytyDTO) {
        ...
        await this.moduleRef.get(anyty_service_1.AnytyService, { strict: false }).createTable(newMetaAnyty);
    }
};
